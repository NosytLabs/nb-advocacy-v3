      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="bg-neutral-900/50 p-10 border border-neutral-800 rounded-2xl md:col-span-2 shadow-xl relative overflow-hidden text-white">
          ...
          <div className="flex flex-col items-center gap-6 mb-6">
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=monero%3A47K21zBzgH5gdoTvLbF2pTQrsRUYsLRTVZkXCuQnyp4tXa4qWqNpfD8dXf2o5PL4R5PeQbEf7Z3xh9hy2BSqCnbD7SrRHHg"
              alt="XMR Donation QR Code"
              width={200}
              height={200}
              className="rounded-xl border border-neutral-700"
            />
            <div className="bg-black/80 p-4 rounded-xl border border-neutral-800 break-all font-mono text-xs md:text-sm text-[#FF6600] text-center shadow-inner select-all selection:bg-[#FF6600] selection:text-black">
